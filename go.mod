...
require (
	...
	golang.org/x/exp v0.0.0-20241210194714-1829a127f884 // lastest version compatible with golang1.20
...
require (
	...
	github.com/sqkam/hysteriaclient v0.0.0-20241215083601-4cc813394043
)
